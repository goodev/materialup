 ...
 */
public class ResourceFragment extends RecyclerFragment<Post> {

    public static ResourceFragment newIns(String sort, String cat, String sub) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new ResourcesAdapter(getActivity());
    }
    ...
    public void loadData() {
        ...
        Api.getApiService().getCategoryStream(mCat, mSub, mCurrentPage, mSort)
                .map(mu -> JsoupUtil.getResources(mu))
